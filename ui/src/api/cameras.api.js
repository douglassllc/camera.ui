...
const iot_camera_control = 'cameracontrol';
...
export const changeCameraControl = async (cameraName, commandData) =>
  await api.patch(`${resource}/${cameraName}/${iot_camera_control}`, commandData);
